...
<?php if (! $__env->hasRenderedOnce('a550b729-571c-4ff7-b7eb-0aca476ae8da')): $__env->markAsRenderedOnce('a550b729-571c-4ff7-b7eb-0aca476ae8da'); ?>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.button','data' => ['class' => 'ml-2','wire:click' => 'confirmPassword','wire:loading.attr' => 'disabled']]); ?>
<?php $component->withName('jet-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['class' => 'ml-2','wire:click' => 'confirmPassword','wire:loading.attr' => 'disabled']); ?>
            <?php echo e($button); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravel8logindashcrud\vendor\laravel\jetstream\src/../resources/views/components/confirms-password.blade.php ENDPATH**/ ?>